...
public class ClientServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (persons != null){
                    for(com.mycompany.personwsapplication.PersonInfo person : persons){
                        out.println("<tr><td>" + person.getName() + "</td><td>" + person.getPosition() + "</td><td>" + person.getSalary() + "</td><td>" + person.getAge() + "</td></tr>");       
                    }
                }
                out.println("</table>");
    ...
    private java.util.List<com.mycompany.personwsapplication.PersonInfo> rPerson() {
